...
![Add Service side panel with the URL Substitutions form open](/images/hermes-on-vps/hermes-on-vps-services-2.png)
...
![Services tab in the prod vault with four services configured](/images/hermes-on-vps/hermes-on-vps-services-1.png)
