...
<AccordionGroup>
  <Accordion title="agent-vault user list">
    ...
    List all users in the instance. Owners see vault memberships; admins see email, role, and creation date.
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="agent-vault owner user info">
    ...
    View user info and vault memberships. If no email is provided, shows your own info. Owner can view any user; admins can only view themselves.
  </Accordion>
