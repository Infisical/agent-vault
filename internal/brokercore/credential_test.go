...
func TestInject_StripsPortForMatching(t *testing.T) {
	...
	p := NewStoreCredentialProvider(f, key32)
	res, err := p.Inject(context.Background(), "v1", "api.example.com:443", 443, "/", "GET")
	if err != nil {
		t.Fatalf("unexpected err: %v", err)
	}
...
func TestInject_WildcardMatch(t *testing.T) {
	...
	p := NewStoreCredentialProvider(f, key32)
	res, err := p.Inject(context.Background(), "v1", "api.github.com", 0, "/", "GET")
	if err != nil {
		t.Fatalf("unexpected err: %v", err)
	}
...
func TestInject_PathBasedDisambiguation(t *testing.T) {
	...
	for _, tc := range cases {
		res, err := p.Inject(context.Background(), "v1", "slack.com", 0, tc.path, "GET")
		if err != nil {
...
func TestInject_UnmatchedHost_HostMissPassthrough(t *testing.T) {
	...
	p := NewStoreCredentialProvider(f, key32)
	res, err := p.Inject(context.Background(), "v1", "other.example.com", 0, "/", "GET")
	if err != nil {
		t.Fatalf("unexpected err: %v", err)
	}
	if res == nil || !res.Passthrough {
...
func TestInject_UnmatchedHost_DenyPolicy(t *testing.T) {
	...
	f.policy = PolicyDeny
	p := NewStoreCredentialProvider(f, make32(0x77))
	_, err := p.Inject(context.Background(), "v1", "api.example.com", 0, "/", "GET")
...
func TestInject_UnmatchedHost_HostMissDeny(t *testing.T) {
	...
	p := NewStoreCredentialProvider(f, key32)
	_, err := p.Inject(context.Background(), "v1", "other.example.com", 0, "/", "GET")
	if !errors.Is(err, ErrServiceNotFound) {
		t.Fatalf("expected ErrServiceNotFound under deny policy, got %v", err)
	}
}
...
func TestInject_ResolvesSubstitutionAlongsideAuth(t *testing.T) {
	...
	p := NewStoreCredentialProvider(f, key32)
	res, err := p.Inject(context.Background(), "v1", "api.twilio.com", 0, "/", "GET")
	if err != nil {
		t.Fatalf("unexpected err: %v", err)
	}
...
func TestInject_SubstitutionMissingCredentialErrorsLikeAuth(t *testing.T) {
	...
	p := NewStoreCredentialProvider(f, key32)
	_, err := p.Inject(context.Background(), "v1", "api.twilio.com", 0, "/", "GET")
	if !errors.Is(err, ErrCredentialMissing) {
		t.Fatalf("expected ErrCredentialMissing, got %v", err)
	}
}
...
func TestInject_PortMatch(t *testing.T) {
	...
	p := NewStoreCredentialProvider(f, key32)
	res, err := p.Inject(context.Background(), "v1", "api.example.com", 8080, "/", "GET")
	if err != nil {
		t.Fatalf("unexpected err: %v", err)
	}
...
func TestInject_PortMismatch(t *testing.T) {
	...
	p := NewStoreCredentialProvider(f, key32)
	res, err := p.Inject(context.Background(), "v1", "api.example.com", 9090, "/", "GET")
	if err != nil {
		t.Fatalf("unexpected err: %v", err)
	}
	if !res.Passthrough {
...
func TestInject_PortSpecificWinsOverGeneral(t *testing.T) {
	...
	p := NewStoreCredentialProvider(f, key32)
	res, err := p.Inject(context.Background(), "v1", "api.example.com", 443, "/", "GET")
	if err != nil {
		t.Fatalf("unexpected err: %v", err)
	}
...
func TestInject_DynamicFallback_Resolves(t *testing.T) {
	...
	res, err := p.Inject(context.Background(), "v1", "db.example.com", 0, "/", "GET")
	if err != nil {
		t.Fatalf("unexpected err: %v", err)
	}
...
func TestInject_DynamicFallback_NotDynamic_StillMissing(t *testing.T) {
	...
	_, err := p.Inject(context.Background(), "v1", "db.example.com", 0, "/", "GET")
	if !errors.Is(err, ErrCredentialMissing) {
		t.Fatalf("expected ErrCredentialMissing, got %v", err)
	}
}
