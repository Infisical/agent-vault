...
- **OAuth Credential Lifecycle**: Import or connect OAuth credentials, validate refresh tokens immediately, and automatically rotate access and refresh tokens. Provider-specific refresh parameters are supported without exposing their values in logs.
