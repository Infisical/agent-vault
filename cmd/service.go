...
func init() {
	...
	serviceAddCmd.Flags().String("auth-type", "", "Auth type: bearer, basic, api-key, custom, oauth, passthrough")
	...
	serviceAddCmd.Flags().String("oauth-client-id", "", "OAuth client id")
	serviceAddCmd.Flags().String("oauth-client-secret-key", "", "Credential key for OAuth client secret")
	serviceAddCmd.Flags().String("oauth-refresh-token-key", "", "Credential key for OAuth refresh token")
	serviceAddCmd.Flags().String("oauth-token-endpoint", "", "OAuth token endpoint URL")
	serviceAddCmd.Flags().StringArray("oauth-scope", nil, "OAuth scope to request on refresh (repeatable)")
