    ...
    <nav className="flex items-center justify-between px-6 py-4 bg-surface border-b border-border">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative group">
          ...
          <span className="pointer-events-none absolute right-0 sm:right-auto sm:left-1/2 sm:-translate-x-1/2 top-full mt-2 px-2.5 py-1 text-xs font-medium text-text bg-surface border border-border rounded-md shadow-[0_4px_16px_rgba(0,0,0,0.1)] opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
            Community
          </span>
        </div>
